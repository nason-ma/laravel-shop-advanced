                            ...
                            <div class="skus">
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    @foreach($product->skus as $sku)
                                        <label
                                            class="btn btn-outline-secondary sku-btn"
...
@section('scriptsAfterJs')
    <script>
        $(document).ready(function () {
            var firstSkuObj = $('.btn-group-toggle').find('label:first');
            setTimeout(function () {
                firstSkuObj.addClass('focus active');
            }, 200);
            $('.product-info .price span').text(firstSkuObj.data('price'));
            $('.product-info .stock').text('库存：' + firstSkuObj.data('stock') + '件');
            $('[data-toggle="tooltip"]').tooltip({trigger: 'hover'});
            $('.sku-btn').click(function () {
                $('.btn-group-toggle').find('label:first').removeClass('focus active');
                $(this).addClass('focus');
